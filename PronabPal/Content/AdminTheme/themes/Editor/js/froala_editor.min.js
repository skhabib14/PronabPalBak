...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.4.0-rc.1", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
        ...
        function e(e, f) {
            ...
            return e.querySelectorAll(a.FE.VOID_ELEMENTS.join(",")).length - e.querySelectorAll("br").length ? !1 : e.querySelector(b.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") ? !1 : e.querySelectorAll(a.FE.BLOCK_TAGS.join(",")).length > 1 ? !1 : e.querySelector(b.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)") ? !1 : !0
        }
        ...
        function p(a) {
            ...
            } else b.doc.selection && "Control" != b.doc.selection.type && (c = b.doc.selection.createRange(), d = c.duplicate(), d.moveToElementText(a), d.setEndPoint("EndToStart", c), e = "" === d.text, d.moveToElementText(a),
                d.setEndPoint("StartToEnd", c), f = "" === d.text);
            return {
                atStart: e,
                atEnd: f
            }
        ...
        function x(c, d) {
            ...
            return e ? (b.node.isBlock(e) ? w(e) : "BR" == e.tagName ? a(e).before(a.FE.MARKERS) : a(e).after(a.FE.MARKERS), !0) : d ? (b.node.isBlock(c) ? v(c) : a(c).before(a.FE.MARKERS), !0) : !1
        }

        function y(c, d) {
            "undefined" == typeof d && (d = !0);
            for (var e = c.nextSibling; e && e.nodeType == Node.TEXT_NODE && 0 == e.textContent.length;) e = e.nextSibling;
            return e ? (b.node.isBlock(e) ? v(e) : a(e).before(a.FE.MARKERS), !0) : d ? (b.node.isBlock(c) ? w(c) : a(c).after(a.FE.MARKERS), !0) : !1
        }
        return {
            text: c,
            get: d,
        ...
        function j(a, c, d, e) {
            return b.$wp ? ("undefined" == typeof a && (a = !1), "undefined" == typeof c && (c = !1), "undefined" == typeof d && (d = !1), "undefined" == typeof e && (e = !1), h(b.el, a), e && i(b.el.querySelectorAll(".fr-inner"), a), c && i(b.el.querySelectorAll("td, th"), a), void(d && i(b.el.querySelectorAll("blockquote"), a))) : !1
        }
        ...
        function B() {
            ...
            if ("undefined" != typeof b.win.getSelection) {
                b.browser.mozilla && (b.selection.save(),
                    b.$el.find('.fr-marker[data-type="false"]').length > 1 && (b.$el.find('.fr-marker[data-type="false"][data-id="0"]').remove(), b.$el.find('.fr-marker[data-type="false"]:last').attr("data-id", "0"), b.$el.find(".fr-marker").not('[data-id="0"]').remove()), b.selection.restore());
        ...
        function g(c) {
            ...
            var d = b.markers.insert();
            if (d) {
                var e = d.previousSibling,
                    f = d.nextSibling;
                !f && d.parentNode && "A" == d.parentNode.tagName ? (d.parentNode.insertAdjacentHTML("afterend", "&nbsp;" + a.FE.MARKERS), d.parentNode.removeChild(d)) : (e && e.nodeType == Node.TEXT_NODE && 1 == e.textContent.length && 160 == e.textContent.charCodeAt(0) ? e.textContent = e.textContent + " " : d.insertAdjacentHTML("beforebegin", "&nbsp;"), d.outerHTML = a.FE.MARKERS), b.selection.restore()
            }
        }
        ...
        function q(c) {
            ...
            c && c.which == a.FE.KEYCODE.ENTER && b.helpers.isIOS() && p(), c && (c.which == a.FE.KEYCODE.ENTER || c.which == a.FE.KEYCODE.BACKSPACE || c.which >= 37 && c.which <= 40 && !b.browser.msie) && (c.which == a.FE.KEYCODE.BACKSPACE && y || o()), b.html.cleanBRs(!0, !0);
            var d = function(a) {
                    if (!a) return !1;
                    var b = a.innerHTML;
                    return b = b.replace(/<span[^>]*? class\s*=\s*["']?fr-marker["']?[^>]+>\u200b<\/span>/gi, ""), b && /\u200B/.test(b) && b.replace(/\u200B/gi, "").length > 0 ? !0 : !1
                },
                e = function(a) {
                    var c = /[\u3041-\u3096\u30A0-\u30FF\u4E00-\u9FFF\u3130-\u318F\uAC00-\uD7AF]/gi;
        ...
        function v(a) {
            var c = a.which;
            return r(a) || c >= 37 && 40 >= c ? !0 : void(A && z && (b.undo.saveStep(A), A = null))
        }
        ...
        function d(a, b) {
            ...
            return e.length ? (c(e), !0) : void 0
        }

        function e(a) {
            return a.is("input[type=text], textarea") && g(), b.events.disableBlur(), a.focus(), !0
        }
        ...
        function i(a) {
            ...
            c.data("mouseenter-event-set") || (b.events.$on(c, "mouseenter", "[tabIndex]", function(d) {
                ...
                if (!C) return d.stopPropagation(), void d.preventDefault();
            ...
            return {
                _tiKeydown: function(g) {
                    ...
                    if (a.FE.KEYCODE.TAB == j) {
                        ...
                        if (n >= 0 && n < m.length) return i.events.disableBlur(), a(m[n]).focus(), g.stopPropagation(), !1;
                        var o = e.find(".fr-buttons");
                        if (o.length && d(o, g.shiftKey ? !0 : !1)) return g.stopPropagation(), !1;
        ...
        function B() {
            b.events.on("keydown", function(c) {
                ...
                return !0
            }, !0), b.events.on("mousedown", function(a) {
                A(b), b.shared.$f_el && (h(b), a.stopPropagation(), b.events.disableBlur(), b.shared.$f_el = null)
            }, !0), b.events.on("blur", function(a) {
                b.shared.$f_el = null, A(b)
            }, !0)
        }
        var C = !0;
        return {
        ...
        function q(a, c) {
            ...
            return i && i.nodeType == Node.ELEMENT_NODE && i != b.el && f(i, e(a, c)) ? !0 : !1
        }
        return {
            is: q,
            toggle: l,
        ...
        function c(c) {
            ...
            if (g.helpers.isIOS() && !g.el.querySelector(".fr-marker") && (g.selection.save(), g.selection.clear(), g.selection.restore()), !e) {
                var h = c.data("cmd");
                d.find(".fr-command").removeClass("fr-active"), a.FE.COMMANDS[h] && a.FE.COMMANDS[h].refreshOnShow && a.FE.COMMANDS[h].refreshOnShow.apply(g, [c, d]), d.css("left", c.offset().left - c.parent().offset().left - ("rtl" == b.opts.direction ? d.width() - c.outerWidth() : 0)), b.opts.toolbarBottom ? d.css("bottom", b.$tb.height() - c.position().top) : d.css("top", c.position().top + c.outerHeight())
            }
            c.addClass("fr-blink").toggleClass("fr-active"), setTimeout(function() {
            ...
            if (c.html) d += "function" == typeof c.html ? c.html.call(b) : c.html;
                ...
                for (var f in e)
                    if (e.hasOwnProperty(f)) {
                        ...
                        g = g ? '<span class="fr-shortcut">' + g + "</span>" : "", d += '<li><a class="fr-command" tabIndex="-1" data-cmd="' + a + '" data-param1="' + f + '" title="' + e[f] + '">' + b.language.translate(e[f]) + "</a></li>"
                    }
                d += "</ul>"
            }
            return d
        ...
        function m(a, c, d) {
            ...
            if ("dropdown" == c.type) {
                var k = '<div class="fr-dropdown-menu"><div class="fr-dropdown-wrapper"><div class="fr-dropdown-content">';
                k += l(a, c), k += "</div></div></div>", j += k
            }
            return j
        }
        ...
        function o(c) {
            var d, e = c.parents(".fr-popup, .fr-toolbar").data("instance") || b,
                f = c.data("cmd");
            b.node.hasClass(c.get(0), "fr-dropdown") ? d = c.next() : c.removeClass("fr-active"), a.FE.COMMANDS[f] && a.FE.COMMANDS[f].refresh ? a.FE.COMMANDS[f].refresh.apply(e, [c, d]) : b.refresh[f] && e.refresh[f](c, d)
        }
        ...
        function p(c) {
            ...
            return 0 == b.events.trigger("buttons.refresh") ? !0 : void setTimeout(function() {
                for (var e = d.selection.inEditor() && d.core.hasFocus(), f = 0; f < c.length; f++) {
                    var g = a(c[f]),
                        h = g.data("cmd");
                    0 == g.parents(".fr-popup").length ? e || a.FE.COMMANDS[h] && a.FE.COMMANDS[h].forcedRefresh ? d.button.refresh(g) : b.node.hasClass(g.get(0), "fr-dropdown") || g.removeClass("fr-active") : g.parents(".fr-popup").is(":visible") && d.button.refresh(g)
                }
            }, 0)
        }
        ...
        function d(c, d) {
            var e = '<div class="fr-modal' + (b.opts.theme ? " " + b.opts.theme + "-theme" : "") + '"><div class="fr-modal-wrapper">',
                f = '<i title="' + b.language.translate("Cancel") + '" class="fa fa-times fr-modal-close"></i>';
            return e += '<div class="fr-modal-head">' + c + f + "</div>", e += '<div class="fr-modal-body">' + d + "</div>", e += "</div></div>", a(e)
        }

        function e(c, e, f) {
            if (b.shared.$overlay || (b.shared.$overlay = a('<div class="fr-overlay">').appendTo("body")), k = b.shared.$overlay, b.opts.theme && k.addClass(b.opts.theme + "-theme"), !l[c]) {
                var g = d(e, f);
                l[c] = {
                    $modal: g,
                    ...
                    h(c)
                }), l[c].$body.css("margin-top", l[c].$head.outerHeight()), h(c)
            }
            return l[c]
        }
        ...
        function f() {
            ...
            k && k.removeData().remove(), l = {}
        }

        function g(a) {
            var c = l[a].$modal;
            c.data("instance", b), c.show(), k.show(), b.$doc.find("body").addClass("prevent-scroll"), b.helpers.isMobile() && b.$doc.find("body").addClass("fr-mobile")
        }

        function h(a) {
            var c = l[a].$modal,
                d = c.data("instance") || b;
            d.events.enableBlur(), c.hide(), k.hide(), d.$doc.find("body").removeClass("prevent-scroll fr-mobile")
        }
                ...
                _repositionPopup: function(e) {
                    ...
                    if (b.$wp && f(c) && d.parent().get(0) == a(b.opts.scrollableContainer).get(0)) {
                        var g = d.offset().top - b.$wp.offset().top,
                            h = b.$wp.outerHeight();
                        b.node.hasClass(d.get(0), "fr-above") && (g += d.outerHeight()), g > h || 0 > g ? d.addClass("fr-hidden") : d.removeClass("fr-hidden")
                    }
                }
            }
        }
        ...
        function h(c) {
            ...
            if (b.core.hasFocus() || b.$tb.find("input:visible:focus").length > 0) {
                ...
                j != f && j != g && (clearTimeout(d.data("sticky-timeout")), d.data("sticky-scheduled", j), d.outerHeight() < i - b.$tb.parent().offset().top && d.addClass("fr-opacity-0"), d.data("sticky-timeout", setTimeout(function() {
                    ...
                    e > 0 && "BODY" == b.$tb.parent().get(0).tagName && (e += b.$tb.parent().position().top), e != f && (d.css("top", Math.max(e, 0)),
                        d.data("sticky-top", e), d.data("sticky-scheduled", e)), d.removeClass("fr-opacity-0")
        ...
        function k() {
            b.events.on("window.mousedown", i), b.events.on("keydown", i), b.events.on("blur", i), b.events.on("window.mouseup", h), b.helpers.isMobile() ? b.helpers.isIOS() || (b.events.on("window.touchend", h), b.browser.mozilla && setInterval(h, 200)) : b.events.on("window.keyup", h), b.events.on("keydown", function(b) {
                ...
                return b.which == a.FE.KEYCODE.ALT ? (b.stopPropagation(), !1) : void 0
        ...
        function p() {
            ...
            }, !0), b.opts.toolbarInline = !1) : b.opts.toolbarInline ? (b.$box.addClass("fr-inline"), b.shared.$tb ? (b.$tb = b.shared.$tb, k()) : (b.shared.$tb = a('<div class="fr-toolbar"></div>'), b.$tb = b.shared.$tb, o())) : (b.$box.addClass("fr-basic"), b.$tb = a('<div class="fr-toolbar"></div>'), o(), b.$tb.data("instance", b)), b.events.on("destroy", n, !0), void b.events.on(b.opts.toolbarInline || b.opts.toolbarContainer ? "shared.destroy" : "destroy", m, !0)) : !1
        }
