...
if (+ function (a) {
    ...
    render: function () {
        ...
        function b(b, e) {
            this.element = b, this.options = a.extend({}, d, e), this._defaults = d, this._name = c, this.init()
}
        var c = "checkAll",
            d = {
    ...
    init: function () {
                var b = a(this.element),
                    c = "input" + this.options.masterCheckbox,
                    d = b.find(c),
                    e = b.find("input" + this.options.otherCheckboxes),
                    f = this.options;
                d.click(function () {
                    e.prop("checked", this.checked), f.highlightRows.active && (e.is(":checked") ? e.closest(f.highlightRows.row).addClass("highlight") : e.closest(f.highlightRows.row).removeClass("highlight")), f.highlightElement.active && (e.is(":checked") ? e.closest(f.highlightElement.elementClass).addClass(f.highlightElement.highlightClass) : e.closest(f.highlightElement.elementClass).removeClass(f.highlightElement.highlightClass))
}), f.highlightRows.active && e.on("change", function () {
                    this.checked ? a(this).closest(f.highlightRows.row).addClass("highlight") : a(this).closest(f.highlightRows.row).removeClass("highlight")
}), f.highlightElement.active && e.on("change", function () {
                    this.checked ? a(this).closest(f.highlightElement.elementClass).addClass(f.highlightElement.highlightClass) : a(this).closest(f.highlightElement.elementClass).removeClass(f.highlightElement.highlightClass)
})
}
}, a.fn.checkAll = function (d) {
            return this.each(function () {
